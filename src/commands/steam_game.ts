...
export const steam_game: CommandInt = {
    ...
    .addStringOption((option) =>
      option
        .setName("game")
        .setDescription("Name of the game (eg. terraria, metro)")
        .setRequired(true)
    ),
    run: async (interaction) => {
        const user = interaction.user.tag;
        console.log(`/steam_game: executed by ${user}`)
        //DO NOT ADD CODE TO THIS. LEAVE IT AS IT IS

        
        console.log(`/steam_game: REFERRED_POMPY_PM0\n/steam_game: This interaction will be handled by the Python module pompy.\n|| See slashcontrol.py at /home/ubuntu/pompy/bot/cogs/slashcontrol.py ||`)
